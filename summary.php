...
<html lang="es">
  ...
  <body>
    ...
    <tbody>
        ...
        <tr>
            <td width="34%"><h4><a  href="javascript:;">Resumen:</a></h4></td>
        </tr>
        <tr>
            <td id="Summary"></td>
        </tr>
      ...
      <div class="row">
        <div class="col-sm-2 col-sm-offset-5 text-center " style="padding-top:40px;">
          <button type="button" onclick="window.location.href='inside.php?thesis_id=<?php echo $_GET['thesis_id']; ?>'" class="btn btn-default">Regresar</button>
        </div>
    ...
    <script src="assets/js/summary.js" type="text/javascript">
