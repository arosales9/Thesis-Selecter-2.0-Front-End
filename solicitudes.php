...
<html lang="es">
  ...
  <body>
    ...
    <div class="container c-principal">
      ...
      <div id="thesis" class="col-xl-8 col-lg-8 col-md-8 col-xs-12 main"><!--Con contenido izquierdo y derecho -->
        <div id="accordion">
  <div class="card">
  ...
  <div class="card">
    ...
    <script src="assets/js/soliciudes.js" type="text/javascript"></script>
